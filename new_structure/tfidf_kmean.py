...
# data path should include in pos_data_strategy folder
data_folder = r'D:\textmining lab demo\Assessment2\Assignment2BlogData\pos_data_strategy\clause_sub\female'
